      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl overflow-hidden shadow-sm p-4 sm:p-6 border border-gray-100">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500">您共有 {/* Cursor提示: "动态计算并显示好友数量" */} 个联系人</p>
          </div>
          ...
          <div className="mt-8 border-t border-gray-100 pt-6">
            ...
            <div className="text-xs space-y-2 text-gray-500">
              <p>• <strong>跨文件代码生成</strong>：尝试 "@page.tsx @index.tsx 动态计算并显示好友数量"</p>
              <p>• <strong>技术方案分析</strong>：尝试 "@index.tsx @FriendItem.tsx 分析这个好友列表的性能优化方案，先不用写出代码"</p>
              <p>• <strong>生成假数据</strong>：尝试 "@friendService.ts  请给好友列表增加20个随机好友数据，包含边界条件验证"</p>
